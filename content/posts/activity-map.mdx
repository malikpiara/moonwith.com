---
title: Activity Map. A way to visualise my writing consistency.
description: A micro product inspired by GitHub.
date: "2023-11-14"
---

I want to build the habit of writing and publishing a blog post every day. To do that, I decided to build a microproduct inspired by Github's contribution calendar. Here's an overview of my thinking process and the final result.

<Image src="/github-activity.png" width="718" height="404" alt="Image of GitHub contribution calendar UI" />
...
This is what the activity map currently looks like. [You can interact with it in real time here](/dashboard).

<Image src="/activity-map.png" width="718" height="404" alt="Image of GitHub contribution calendar UI" />
