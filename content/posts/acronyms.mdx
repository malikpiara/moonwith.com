...
description: 'The goal of communication is to convey information.'
date: '2021-02-17'
...
Whenever you're working with other people, make mutual understanding a priority above all else. Avoid using acronyms, initialisms, abbreviations.
